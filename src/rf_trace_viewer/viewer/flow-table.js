...
(function () {
  ...
  function _createRow(row, hlId, state) {
    ...
    // For EXTERNAL/GENERIC keywords, the inline context line already shows
    // the key HTTP/DB info. Full details are in the tree node detail panel.
    // No separate detail row needed in the flow table.
