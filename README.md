...
<sub>Demo auto-generated by a [Robot Framework + Browser library suite](https://github.com/xtergo/robotframework-trace-report/blob/main/docs/demo/generate_demo_gif.robot). [Try the interactive demo →](https://xtergo.github.io/robotframework-trace-report/)</sub>
